...
public class C01_ExplicitlyWait {
    ...
    public void explicitlyWaitTest(){
        ...
        /*
            visibilityof() method'u bize iki secenek sunuyor
            - Eger WebElement'i locate edebiliyorsa, once locate edip
              sonra o element'i istenen condition icin bekelemesini isteyebiliriz
